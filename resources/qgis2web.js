...
map.getView().fit([-4689803.191843, -2579579.369662, -4640709.508855, -2556303.562031], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Prefeitura Municipal de Rio das Ostras - Unidades Sociais</h2>';
        return titleElement;
    })(),
